...
.controller('faceDetectionCtrl', function ($scope, FileUploadService) {
    ...
    $scope.Title = 'Face detection using Congnitive Services - GABC';
    $scope.DetectedResultsMessage = 'Sorry, no results found.';
    ...
    $scope.selectCandidateFileforUpload = function (file) {
        ...
        $scope.uplMessage = 'Hold on while the image is being uploaded';
    ...
    $scope.GetDetectedFaces = function () {
        ...
        $scope.faceMessage = 'Sit back and relax while we are detecting face(s) for you!';
        $scope.result = "color-red";
